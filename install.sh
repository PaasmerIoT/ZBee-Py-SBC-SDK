...
cd $path/sensor
#wget -O geekman-python-eeml.tar.gz https://github.com/geekman/python-eeml/tarball/master >> .Install.log
tar zxvf geekman-python*.tar.gz >> .Install.log
cd geekman-python-eeml*
sudo python setup.py install >> .Install.log
echo "---------------------"
pwd
cp ../../ReadVal.py $path/sensor/geekman-python-eeml-a7d2949/
